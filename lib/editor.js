...
var DraftMirrorEditor = React.createClass({
    ...
    onStartFlushing: function() {
        this._flushing = true;
        this._callOnChanged = false;
    },

    onEndFlushing: function() {
        this._flushing = false;
        if (this._callOnChanged) {
            this.onChanged();
        }
    },
    ...
    bindListeners: function (editor, action) {
        this.editor.on.change[action](this.onChanged);
        this.editor.on.selectionChange[action](this.onChanged);
        this.editor.on.filterTransform[action](this.onFilterTransform);
        this.editor.on.clickOn[action](this.onClickOn);
        this.editor.on.activeMarkChange[action](this.onChanged);
        this.editor.on.flushing[action](this.onStartFlushing);
        this.editor.on.flush[action](this.onEndFlushing);
    },
