...
var DraftMirrorEditor = React.createClass({
    ...
    renderTooltip: function() {
        ...
        var absoluteBox = tooltip.parentNodeBoundingBox(this.editor, selection);
        var boundingBox = tooltip.relativeCoords(this.editor, absoluteBox);
        return React.createElement('div', {
            className: classNames('DraftMirrorEditor-Tooltip'),
            style: {
                backgroundColor: '#f00',
                opacity: '0.5',
                left: boundingBox.left,
                top: boundingBox.top,
                width: boundingBox.right - boundingBox.left + 3,
                height: boundingBox.bottom - boundingBox.top + 3
            }
        }, '');
    },
